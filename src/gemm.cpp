...
//         gamma_0123_0 = _mm256_add_pd(gamma_0123_0, _mm256_mul_pd(alpha_0123_p, beta_j));
//         gamma_4567_0 = _mm256_add_pd(gamma_4567_0, _mm256_mul_pd(alpha_4567_p, beta_j));
//         gamma_89AB_0 = _mm256_add_pd(gamma_89AB_0, _mm256_mul_pd(alpha_89AB_p, beta_j));

//         beta_j = _mm256_broadcast_sd(bp + 1);
//         gamma_0123_1 = _mm256_add_pd(gamma_0123_1, _mm256_mul_pd(alpha_0123_p, beta_j));
//         gamma_4567_1 = _mm256_add_pd(gamma_4567_1, _mm256_mul_pd(alpha_4567_p, beta_j));
//         gamma_89AB_1 = _mm256_add_pd(gamma_89AB_1, _mm256_mul_pd(alpha_89AB_p, beta_j));

//         beta_j = _mm256_broadcast_sd(bp + 2);
//         gamma_0123_2 = _mm256_add_pd(gamma_0123_2, _mm256_mul_pd(alpha_0123_p, beta_j));
//         gamma_4567_2 = _mm256_add_pd(gamma_4567_2, _mm256_mul_pd(alpha_4567_p, beta_j));
//         gamma_89AB_2 = _mm256_add_pd(gamma_89AB_2, _mm256_mul_pd(alpha_89AB_p, beta_j));

//         beta_j = _mm256_broadcast_sd(bp + 3);
//         gamma_0123_3 = _mm256_add_pd(gamma_0123_3, _mm256_mul_pd(alpha_0123_p, beta_j));
//         gamma_4567_3 = _mm256_add_pd(gamma_4567_3, _mm256_mul_pd(alpha_4567_p, beta_j));
//         gamma_89AB_3 = _mm256_add_pd(gamma_89AB_3, _mm256_mul_pd(alpha_89AB_p, beta_j));
...
void kernel_packed(int k, double* ap, double* bp, double* C, int ldC) {
    ...
    for (int p = 0; p < k; ++p) {
        ...
        gamma_0123_4 = _mm256_add_pd(gamma_0123_4, _mm256_mul_pd(alpha_0123_p, beta_j));
        gamma_4567_4 = _mm256_add_pd(gamma_4567_4, _mm256_mul_pd(alpha_4567_p, beta_j));

        beta_j = _mm256_broadcast_sd(bp + 5);
        gamma_0123_5 = _mm256_add_pd(gamma_0123_5, _mm256_mul_pd(alpha_0123_p, beta_j));
        gamma_4567_5 = _mm256_add_pd(gamma_4567_5, _mm256_mul_pd(alpha_4567_p, beta_j));
...
void JPI_JI_Loop_Packed(int m, int n, int k, double* a, int ldA, double* b, int ldB, double* c, int ldC) {
    ...
    for (int J = 0; J < n; J += NC) {
        for (int P = 0; P < k; P += KC) {
            packB(std::min(KC, k - P), std::min(NC, n - J), b + P, ldB, btilde);

            for (int I = 0; I < m; I += MC) {
                packA(std::min(MC, m - I), std::min(KC, k - P), a + I, ldA, atilde);
